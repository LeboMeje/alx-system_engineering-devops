...
Project done during **Full Stack Software Engineering studies** at **ALX SE School**. It aims to learn about PID, processes and commands that handles them (`ps`, `pgrep`, `pkill`, `kill`, etc) in **Bash**.
...
| `manage_my_process` | Script manages `start`, `display`, `stop` & `restart` instructions |
